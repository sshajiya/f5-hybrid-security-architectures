resource "kubernetes_ingress_v1" "arcadia-ingress" {
  ...
  spec {
    ...
    rule {
      host = try(data.tfe_outputs.nap[0].values.external_name, data.tfe_outputs.nic[0].values.external_name, "a9991535679dd4eeaa808891d6c98afb-1889258750.ap-south-1.elb.amazonaws.com")      
